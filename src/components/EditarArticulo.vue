    ...
    <v-container>
      ...
      <v-row>
          <v-col>         
              ...
              ></v-text-field>
              <v-card-actions>
              <v-btn style="background-color: rgb(80, 178, 235);" type="submit">
  ...
  export default {
      ...
      methods:{
        guardarArticulo(){
          ...
          axios.put('http://localhost/apirest/articulos.php?id='+this.id+'&descripcion='+this.articulo.descripcion+'&precio='+this.articulo.precio+'&stock='+this.articulo.stock)
          .then(function(){
